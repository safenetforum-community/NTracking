...
# sudo rm -f /usr/bin/scrape.sh* && sudo wget -P /usr/bin  https://github.com/safenetforum-community/NTracking/edit/main/anm/scripts/scrape.sh && sudo chmod u+x /usr/bin/scrape.sh
